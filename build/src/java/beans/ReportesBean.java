 ...
 * @author Ismael Ruiz
 */
public class ReportesBean extends Conexion implements Serializable {
    ...
    //Metodo que crea el reporte de Inventario
    public void reporteJasperReport() throws ServletException, IOException, ClassNotFoundException, JRException, SQLException, ParseException {
        try {
            ...
            String jrxmlFileName = ctx.getRealPath("/Jasper/Archivo.jrxml");
            ...
            JasperExportManager.exportReportToPdfFile(print, urlPdfFileName + "/Archivo.pdf");
            this.setUrlPdfFile(this.getUrlReportesPdf() + "Archivo.pdf");
            this.setNameReport("TITULO DEL REPORTE");
